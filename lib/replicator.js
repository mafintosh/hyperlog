...
module.exports = function(hyper, opts) {
  ...
  var metadata = typeof opts.metadata === 'string' ? new Buffer(opts.metadata) : opts.metadata
  ...
  hyper.ready(function() {
    stream.handshake({version:1, changes:hyper.change, mode:mode, metadata:metadata})
  })
